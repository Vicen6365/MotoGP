...
object CircuitData {
    val circuits: List<CircuitInfo> = listOf(
        CircuitInfo("Chang International Circuit",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/7/79/Buriram_circuit_map.svg/800px-Buriram_circuit_map.svg.png",
        ...
        CircuitInfo("Autódromo Termas de Río Hondo",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/Termas_de_R%C3%ADo_Hondo.svg/800px-Termas_de_R%C3%ADo_Hondo.svg.png",
        ...
        CircuitInfo("Circuito de Jerez - Ángel Nieto",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/a/aa/Circuito_de_Jerez_v2.svg/800px-Circuito_de_Jerez_v2.svg.png",
            "Circuito histórico con la famosa curva 'Dry Sack'. Ambiente único."),
        CircuitInfo("Bugatti Circuit (Le Mans)",
            "French GP", "Francia", "🇫🇷",
            "4.185 km", 14, "Stop & Go",
            "1'31.247", "J. Martin", "2024",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/6/69/Bugatti_Circuit.svg/800px-Bugatti_Circuit.svg.png",
        ...
        CircuitInfo("Circuit de Barcelona-Catalunya",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Circuit_de_Catalunya_moto_2021.svg/800px-Circuit_de_Catalunya_moto_2021.svg.png",
        ...
        CircuitInfo("Mugello Circuit",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Mugello_Racing_Circuit_track_map_15_turns.svg/800px-Mugello_Racing_Circuit_track_map_15_turns.svg.png",
            "Trazado de alta velocidad. Recta larguísima de más de 1 km."),
        CircuitInfo("Balaton Park Circuit",
            "Hungarian GP", "Hungría", "🇭🇺",
            "4.547 km", 15, "Técnico",
            "—", "—", "—",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Balaton_Park_Circuit_layout_%28motorcycle_racing%29.svg/800px-Balaton_Park_Circuit_layout_%28motorcycle_racing%29.svg.png",
        ...
        CircuitInfo("TT Circuit Assen",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f0/TT_Circuit_Assen_moto.svg/800px-TT_Circuit_Assen_moto.svg.png",
            "La 'Catedral' del motociclismo. Curvas rápidas y peralte natural."),
        CircuitInfo("Sachsenring",
            "German GP", "Alemania", "🇩🇪",
            "3.671 km", 13, "Técnico",
            "1'20.113", "J. Martin", "2025",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Sachsenring.svg/800px-Sachsenring.svg.png",
        ...
        CircuitInfo("Silverstone Circuit",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Silverstone_Circuit_2020.png/800px-Silverstone_Circuit_2020.png",
            "El circuito más largo del calendario. Curvas de alta velocidad."),
        CircuitInfo("Red Bull Ring",
            "Austrian GP", "Austria", "🇦🇹",
            "4.318 km", 10, "Stop & Go",
            "1'22.913", "J. Martin", "2025",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Red_Bull_Ring_moto_2022.svg/800px-Red_Bull_Ring_moto_2022.svg.png",
        ...
        CircuitInfo("Motorland Aragón",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/0/03/Motorland_Arag%C3%B3n_FIM.svg/800px-Motorland_Arag%C3%B3n_FIM.svg.png",
        ...
        CircuitInfo("Misano World Circuit",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/5/56/Misano_World_Circuit.svg/800px-Misano_World_Circuit.svg.png",
        ...
        CircuitInfo("Mobility Resort Motegi",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3e/Twin_Ring_Motegi_map-2.svg/800px-Twin_Ring_Motegi_map-2.svg.png",
        ...
        CircuitInfo("Mandalika International Street Circuit",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Mandalika_International_Street_Circuit.svg/800px-Mandalika_International_Street_Circuit.svg.png",
        ...
        CircuitInfo("Phillip Island Grand Prix Circuit",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Phillip_Island_Grand_Prix_Circuit_v2022.svg/800px-Phillip_Island_Grand_Prix_Circuit_v2022.svg.png",
        ...
        CircuitInfo("Sepang International Circuit",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/6/67/Sepang.svg/800px-Sepang.svg.png",
            "Ancho y largo circuito. Calor y humedad extremos."),
        CircuitInfo("Lusail International Circuit",
            "Qatar GP", "Qatar", "🇶🇦",
            "5.380 km", 16, "Stop & Go",
            "1'52.637", "F. Bagnaia", "2025",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c7/Lusail_International_Circuit_2023.svg/800px-Lusail_International_Circuit_2023.svg.png",
            "Carrera nocturna con focos. Arena y curvas anchas."),
        CircuitInfo("Autódromo Internacional do Algarve",
            "Portuguese GP", "Portugal", "🇵🇹",
            "4.653 km", 15, "Mixto",
            "1'39.555", "J. Mir", "2021",
            "https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Aut%C3%B3dromo_do_Algarve_moto.svg/800px-Aut%C3%B3dromo_do_Algarve_moto.svg.png",
        ...
        CircuitInfo("Circuit Ricardo Tormo",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Valencia_%28Ricardo_Tormo%29_track_map.svg/800px-Valencia_%28Ricardo_Tormo%29_track_map.svg.png",
        ...
        CircuitInfo("Automotodrom Brno",
            ...
            "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f9/Brno_%28formerly_Masaryk%C5%AFv_okruh%29.svg/800px-Brno_%28formerly_Masaryk%C5%AFv_okruh%29.svg.png",
